        ...
        //var getName=prompt('Hi! First time here, what is your name?','');
          ...
          // document.getElementById("div").addEventListener("change", move);
             div.setAttribute("id","div1");
                        document.getElementById("form").appendChild(div);

            document.getElementById("div1").addEventListener("change", function(){ move(this); });
            ...
            //sel1.addEventListener("change", changeTeam);
            div.appendChild(sel1);
            document.getElementById("select1").addEventListener("change", function(){ changeTeam(this.value) });
...
//changeTeam()        
        function changeTeam(choice){
           ...
           // console.log(nodelist);
            ...
            if(choices[0]=="End"){
               ...
               // var statement=document.createTextNode(summary);
                span.appendChild(document.createTextNode("Division:   "+localStorage.getItem('sel0')));//+choices[1]));
                //span.appendChild(statement);
               span.appendChild(document.createElement("br")); span.appendChild(document.createTextNode("Team:   "+localStorage.getItem('sel1')));//+choices[2]));
               span.appendChild(document.createElement("br")); span.appendChild(document.createTextNode("Logo Years:   "+localStorage.getItem('sel2')));//+choices[3]));
			...
			var myNode = document.getElementById(choice.parentNode.id);
                var num=nodelist+1;
                removeOld(myNode);
             var div = document.createElement("div");
           ...
           sel1.setAttribute("id","select"+num);
            sel1.setAttribute("onchange", "changeTeam(this.value)");
            div.appendChild(sel1);
            document.getElementById("select"+num).addEventListener("change", function(){ changeTeam(this.value) });
